  ...
  return (
    <Box p={3}>
          ...
          <li>
            <Box p={1} component={Typography} textAlign="justify">
              <Box p={2} component={Typography} textAlign="justify">
                ...
                (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to MobileCoin TS
                Ltd, Floor 4, Banco Popular Building, Road Town, Tortola VG1110, British Virgin Islands.
              </Box>
              <Box p={2} component={Typography} textAlign="justify">
          ...
          <li>
            <Box p={1} component={Typography} textAlign="justify">
              <Box p={2} component={Typography} textAlign="justify">
                ...
                , for the purposes of the GDPR (General Data Protection Regulation), refers to the Company as the legal
          ...
          <li>
            <Box p={1} component={Typography} textAlign="justify">
              <Box p={2} component={Typography} textAlign="justify">
                ...
                analyzing how the Service is used. For the purpose of the GDPR, Service Providers are considered Data
                Processors.
              </Box>
            </Box>
          </li>
        ...
        <ul>
          ...
          <li>
            <Box p={1} component={Typography} textAlign="justify">
              ...
              same browser settings as those used for Browser Cookies. For more information on how You can delete Flash
      ...
      <Box p={2} component={Typography} textAlign="justify">
        ...
        about cookies: https://www.privacypolicies.com/blog/cookies/ .
      </Box>
      <Box p={2} component={Typography} textAlign="justify">
      ...
      <Box
        ...
        data-testid="privacy-personal-data-use"
      >
        ...
        <ul>
          ...
          <li>
            <Box p={1} component={Typography} textAlign="justify">
              ...
              users or register through a Third-Party Social Media Service, Your contacts on the Third-Party Social
              Media Service may see Your name, profile, pictures and description of Your activity. Similarly, other
        ...
        <ul>
          ...
          <li>
            <Box p={1} component={Typography} textAlign="justify">
              ...
              Processing Personal Data is necessary for compliance with a legal obligation to which the Company is
              subject.
            </Box>
          </li>
          <li>
            <Box p={1} component={Typography} textAlign="justify">
              ...
              Processing Personal Data is necessary in order to protect Your vital interests or of another natural
              person.
            </Box>
          </li>
          <li>
        ...
        <ul>
          <li>
            <Box p={1} component={Typography} textAlign="justify">
              ...
              you are unable to perform these actions yourself, please contact Us to assist You. This also enables You
          ...
          <li>
            <Box p={1} component={Typography} textAlign="justify">
              ...
              This right exists where We are relying on a legitimate interest as the legal basis for Our processing and
              there is something about Your particular situation, which makes You want to object to our processing of
              Your Personal Data on this ground. You also have the right to object where We are processing Your Personal
          ...
          <li>
            <Box p={1} component={Typography} textAlign="justify">
              ...
              You have the right to ask Us to delete or remove Personal Data when there is no good reason for Us to
          ...
          <li>
            <Box p={1} component={Typography} textAlign="justify">
              ...
              We will provide to You, or to a third-party You have chosen, Your Personal Data in a structured, commonly
              used, machine-readable format. Please note that this right only applies to automated information which You
      ...
      <Box pl={6}>
        <ul>
          <li>
            <Box p={1} component={Typography} textAlign="justify">
              By email: privacy@mobilecoinww.com
            </Box>
          </li>
        </ul>
      </Box>
