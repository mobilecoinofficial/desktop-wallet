  ...
  return (
    <Box p={3}>
          ...
          <li>
            <Box p={1} component={Typography} textAlign="justify">
              <Box p={2} component={Typography} textAlign="justify">
                ...
                this Agreement) refers to MobileCoin TS Ltd, Floor 4, Banco
                Popular Building, Road Town, Tortola VG1110, British Virgin
                Islands.
              </Box>
              <Box p={2} component={Typography} textAlign="justify">
      ...
      <Box p={2} component={Typography} textAlign="justify">
        ...
        Learn more about cookies: https://www.privacypolicies.com/blog/cookies/
        .
      </Box>
      <Box p={2} component={Typography} textAlign="justify">
