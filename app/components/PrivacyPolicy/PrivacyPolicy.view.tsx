        ...
        <li>
          <Box p={1} component={Typography} textAlign="justify">
            <Box p={2} component={Typography} textAlign="justify">
              ...
              MobileCoin TS Ltd, Floor 4, Banco Popular Building, Road Town, Tortola VG1110, British
              Virgin Islands.
            </Box>
            <Box p={2} component={Typography} textAlign="justify">
      ...
      <ul>
        ...
        <li>
          <Box p={1} component={Typography} textAlign="justify">
            ...
            Processing Personal Data is related to a task that is carried out in the public interest
      ...
      <ul>
        ...
        <li>
          <Box p={1} component={Typography} textAlign="justify">
            ...
            want to object to our processing of Your Personal Data on this ground. You also have the
        ...
        <li>
          <Box p={1} component={Typography} textAlign="justify">
            ...
            You have the right to withdraw Your consent on using your Personal Data. If You withdraw
