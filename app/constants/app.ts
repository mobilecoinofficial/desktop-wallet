...
export const TIME_FOR_INACTIVITY = 300_000; // after this time, will be considered inactive: 5'
export const TIME_FOR_REACTION = 30_000; // extra time to avoid closing: 30"
