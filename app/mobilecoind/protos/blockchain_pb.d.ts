...
export class BlockContentsHash extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: BlockContentsHash): BlockContentsHash.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: BlockContentsHash, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): BlockContentsHash;
    static deserializeBinaryFromReader(message: BlockContentsHash, reader: jspb.BinaryReader): BlockContentsHash;
}
...
export class BlockContents extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: BlockContents): BlockContents.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: BlockContents, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): BlockContents;
    static deserializeBinaryFromReader(message: BlockContents, reader: jspb.BinaryReader): BlockContents;
}
...
export class ArchiveBlockV1 extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: ArchiveBlockV1): ArchiveBlockV1.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: ArchiveBlockV1, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): ArchiveBlockV1;
    static deserializeBinaryFromReader(message: ArchiveBlockV1, reader: jspb.BinaryReader): ArchiveBlockV1;
}
