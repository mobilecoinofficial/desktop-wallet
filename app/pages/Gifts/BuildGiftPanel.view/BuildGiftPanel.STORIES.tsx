...
export const InitialInput = Template.bind({});
InitialInput.args = {
  confirmation: {
  ...
  selectedAccount: {
    ...
    balanceStatus: {
      accountBlockHeight: '159586',
      isSynced: true,
      localBlockHeight: '159586',
      networkBlockHeight: '159586',
      object: 'balance',
      orphanedPmob: '0',
      pendingPmob: '0',
      secretedPmob: '0',
...
export const ConfirmBuild = Template.bind({});
ConfirmBuild.args = {
  confirmation: {
    feeConfirmation: 400000000n,
    giftCodeB58:
