...
export const PrivacyPolicy = (): JSX.Element => (
  <Box p={3} color="text.primary">
    ...
    <Box p={2} textAlign="justify">
      <Typography>Last updated: December 04, 2020</Typography>
    </Box>
    <Box p={2} textAlign="justify">
      <Typography>
    ...
    <Box p={2} textAlign="justify" style={{ textDecoration: 'underline' }}>
      <Typography>Interpretation and Definitions</Typography>
    </Box>
    <Box p={2} textAlign="justify" style={{ textDecoration: 'underline' }}>
        ...
        <li>
          <Box p={1} textAlign="justify">
            <Box p={2} textAlign="justify">
              ...
              <Typography display="inline">refers to: British Virgin Islands</Typography>
            </Box>
          </Box>
        </li>
        <li>
          <Box p={1} textAlign="justify">
            <Box p={2} textAlign="justify">
              ...
              <Typography display="inline">
                ...
                Company as the legal person which alone or jointly with others determines the
        ...
        <li>
          <Box p={1} textAlign="justify">
            <Box p={2} textAlign="justify">
              ...
              <Typography display="inline">refers to the Website.</Typography>
            </Box>
          </Box>
        </li>
        <li>
          <Box p={1} textAlign="justify">
            <Box p={2} textAlign="justify">
              ...
              <Typography display="inline">
                ...
                services related to the Service or to assist the Company in analyzing how the
    ...
    <Box p={2} textAlign="justify" style={{ textDecoration: 'underline' }}>
      <Typography>Collecting and Using Your Personal Data</Typography>
    </Box>
    <Box p={2} textAlign="justify" style={{ textDecoration: 'underline' }}>
    ...
    <Box p={2} style={{ textDecoration: 'underline' }}>
        ...
        <li>
          <Box p={1} textAlign="justify">
            ...
            <Typography display="inline">
              ...
              at https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#
        ...
        <li>
          <Box p={1} textAlign="justify">
            <Box p={2} textAlign="justify">
              ...
              <Typography display="inline">To attend and manage Your requests to Us.</Typography>
            </Box>
          </Box>
        </li>
        <li>
    ...
    <Box p={2} textAlign="justify" style={{ textDecoration: 'underline' }}>
      <Typography>Disclosure of Your Personal Data</Typography>
    </Box>
    <Box p={2} textAlign="justify" style={{ textDecoration: 'underline' }}>
    ...
    <Box p={2} textAlign="justify" style={{ textDecoration: 'underline' }}>
      <Typography>GDPR Privacy</Typography>
    </Box>
    <Box p={2} textAlign="justify" style={{ textDecoration: 'underline' }}>
      <Typography>Legal Basis for Processing Personal Data under GDPR</Typography>
    </Box>
    <Box p={2} textAlign="justify">
      <Typography>We may process Personal Data under the following conditions:</Typography>
    </Box>
    <Box pl={6}>
      <ul>
        <li>
    ...
    <Box p={2} textAlign="justify" style={{ textDecoration: 'underline' }}>
      <Typography>Your Rights under the GDPR</Typography>
    </Box>
    <Box p={2} textAlign="justify">
      <Typography>
        ...
        <li>
          <Box p={1} textAlign="justify">
            ...
            <Typography display="inline">
              ...
              yourself, please contact Us to assist You. This also enables You to receive a copy of
    ...
    <Box p={2} textAlign="justify" style={{ textDecoration: 'underline' }}>
      <Typography>Exercising of Your GDPR Data Protection Rights</Typography>
    </Box>
    <Box p={2} textAlign="justify">
      <Typography>
    ...
    <Box p={2} textAlign="justify" style={{ textDecoration: 'underline' }}>
      <Typography>Links to Other Websites</Typography>
    </Box>
    <Box p={2} textAlign="justify">
      <Typography>
    ...
    <Box pl={6}>
      <ul>
        <li>
          <Box p={1} textAlign="justify">
            <Typography>By email: privacy@mobilecoinww.com</Typography>
          </Box>
        </li>
      </ul>
    </Box>
