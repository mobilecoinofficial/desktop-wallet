...
const FAKE_DATA = [
  fake('lkj', new Date('2022-02-04T16:32:00'), 'Peter Smithson', 4.6478654, 'sent', 'pending'),
  ...
  fake('mnb', new Date('2020-12-22T23:54:00'), '8gh5-3fh5', 5.645, 'sent', 'succeeded'),
  ...
  fake('ytr', new Date('2020-10-14T20:56:00'), '9kj3-vm3f', 2.824, 'sent', 'succeeded'),
  fake('rew', new Date('2020-10-11T19:11:00'), 'Richard Simpson', 0.567, 'sent', 'succeeded'),
];
