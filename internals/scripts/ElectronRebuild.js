...
if (Object.keys(dependencies || {}).length > 0 && fs.existsSync(nodeModulesPath)) {
  const electronRebuildCmd =
    ...
    // '../node_modules/.bin/electron-rebuild --prebuild-tag-prefix --sequential --types prod,dev,optional --module-dir .';
    '../node_modules/.bin/electron-rebuild --sequential --types prod,dev,optional --module-dir .';
  const cmd =
