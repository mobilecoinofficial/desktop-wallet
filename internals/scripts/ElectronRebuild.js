...
if (Object.keys(dependencies || {}).length > 0 && fs.existsSync(nodeModulesPath)) {
  Object.getOwnPropertyNames(dependencies).forEach((val) => {
    console.log(`*****${val} -> ${dependencies[val]}*****`);
    const electronRebuildCmd =
      // '../node_modules/.bin/electron-rebuild --s --w keytar,argon2 --types prod,dev,optional --module-dir .';
      `../node_modules/.bin/electron-rebuild --s --f --types prod,dev,optional --module-dir ./node_modules/${val}`;
    const cmd =
